...
class _SeriesScreenState extends State<SeriesScreen> {
  ...
  Future<void> _loadSeriesDetails() async {
    if (AppState.currentPlaylist == null) {
      if (!mounted) return;
      setState(() {
        error = 'Aktif playlist bulunamadı';
        isLoading = false;
      });
      return;
    }
  ...
  Widget _buildContinueWatchingButton() {
    ...
    return FocusableControlBuilder(
      onPressed: () => _openEpisodeFromSeries(episode),
      builder: (context, state) {
        final isFocused = state.isFocused;
        return AnimatedScale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isFocused ? const Color(0xFFE50914) : backgroundColor,
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  size: 30,
                  color: isFocused ? Colors.white : contentColor,
                ),
  ...
  Widget _buildSeasonCard(SeasonsData season, int index) {
    ...
    return FocusableControlBuilder(
      onPressed: () => _showSeasonEpisodes(season),
      builder: (context, state) {
        final isFocused = state.isFocused;
        return AnimatedScale(
          scale: isFocused ? 1.05 : 1.0,
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(
                          ...
                          size: 20,
                          color: isFocused ? const Color(0xFFE50914) : Theme.of(context).primaryColor,
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      color: isFocused ? Colors.white70 : Colors.grey.shade600,
                    ),
                  ),
                  if (season.airDate != null) ...[
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color: isFocused ? Colors.white60 : Colors.grey.shade500,
                      ),
                    ),
                  ],
                ],
                      ...
                      children: [
                        ...
                        if (episode.plot != null && episode.plot!.isNotEmpty) ...[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color: isFocused ? Colors.white60 : Colors.grey.shade600,
                            ),
                          ),
                        ],
                      ],
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    size: 20,
                    color: isFocused ? const Color(0xFFE50914) : Colors.red,
                  ),
                ),
                const SizedBox(width: 16),
                Text(
