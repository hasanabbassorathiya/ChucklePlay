  ...
  Future<void> _loadCategoryMovies() async {
    try {
      if (isXtreamCode && _repository != null) {
        ...
        if (categoryId != null && m3uRepo != null) {
      ...
      builder: (context, state) {
        ...
        return AnimatedScale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isFocused ? const Color(0xFFE50914) : Colors.red.withOpacity(0.2),
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.ondemand_video, color: isFocused ? Colors.white : Colors.red),
                const SizedBox(width: 8),
                Text(
                  context.loc.trailer,
                  style: TextStyle(
          ...
          children: [
            ...
            AnimatedScale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isFocused ? const Color(0xFFE50914) : theme.colorScheme.primary,
                  borderRadius: BorderRadius.circular(12),
                  border: isFocused ? Border.all(color: Colors.white, width: 2) : null,
                  boxShadow: isFocused
                      ? [
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 32,
                      color: isFocused ? Colors.white : theme.colorScheme.onPrimary,
                    ),
                    const SizedBox(width: 8),
                    Text(
                      label,
