import 'package:lumio/controllers/m3u_controller.dart';
...
class NewM3uPlaylistScreenState extends State<NewM3uPlaylistScreen> {
            ...
            children: [
              Expanded(
                child: FocusableControlBuilder(
                  onPressed: () => _onSourceTypeChanged(true),
                  builder: (context, state) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: _isUrlSource
                            ? colorScheme.primary
                            : (isFocused ? colorScheme.primary.withOpacity(0.1) : Colors.transparent),
              ...
              Expanded(
                child: FocusableControlBuilder(
                  onPressed: () => _onSourceTypeChanged(false),
                  builder: (context, state) {
                    final isFocused = state.isFocused;
                    return Container(
                      padding: EdgeInsets.symmetric(vertical: 16, horizontal: 20),
  ...
  Widget _buildEpgUrlField(ColorScheme colorScheme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: isFocused ? colorScheme.primaryContainer : colorScheme.primary,
              foregroundColor: isFocused ? colorScheme.onPrimaryContainer : colorScheme.onPrimary,
              ...
              elevation: controller.isLoading ? 0 : (isFocused ? 4 : 2),
            ),
                      ...
                      SizedBox(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation<Color>(
                            isFocused ? colorScheme.onPrimaryContainer : colorScheme.onPrimary,
                          ),
                        ),
                      ),
                      SizedBox(width: 12),
  ...
  Future<void> _savePlaylist() async {
    if (_formKey.currentState!.validate()) {
      ...
      var playlist = await playlistController.createPlaylist(
        ...
        epgUrl: _epgUrlController.text.trim().isNotEmpty ? _epgUrlController.text.trim() : null,
      );
