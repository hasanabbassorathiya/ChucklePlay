...
import 'package:lumio/controllers/iptv_controller.dart';
...
import '../home/stb_dashboard_screen.dart';
      ...
      Navigator.pushAndRemoveUntil(
        ...
        MaterialPageRoute(
          builder: (context) => ChangeNotifierProvider.value(
            value: _controller,
            child: StbDashboardScreen(playlist: widget.playlist),
          ),
        ),
        (route) => false,
      );
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Icon(
                                        stepIcons[controller.currentStep] ?? Icons.download,
                                        size: 40,
                                        color: Colors.white,
                                      ),
                                    ),
                          ...
                          Text(
                            stepTitles[controller.currentStep] ?? context.loc.connecting,
                            style: TextStyle(
                              fontSize: 18,
